...
class MyRoot(RootController):
    ...
    bindargs = error_handler(
        bind_args(baz=123)(simpleerrorhandler))(bindargs)
    bindargs = validate(validators={
        "bar": validators.Int(not_empty=True)})(bindargs)
    ...
    notexposed = validate(validators={
        "bar": validators.Int(not_empty=True)})(notexposed)
    ...
    continuationcaller = validate(validators={
        "bar": validators.Int(not_empty=True)})(continuationcaller)
    ...
    failsafevaluesdict = validate(validators={
        "bar": validators.Int(not_empty=True),
    ...
    failsafevaluesatom = validate(validators={
        "bar": validators.Int(not_empty=True),
        "baz": validators.Int(not_empty=True)},
            failsafe_schema=FailsafeSchema.values,
    ...
    failsafemaperrors = validate(validators={
        "bar": validators.Int(not_empty=True),
        "baz": validators.Int(not_empty=True)},
            failsafe_schema=FailsafeSchema.map_errors)(failsafemaperrors)
    ...
    failsafeformencode = validate(validators={
        "bar": validators.Int(if_invalid=1),
        "baz": validators.Int(if_invalid=2)})(failsafeformencode)
    ...
    failsafedefaults = validate(validators={
        "bar": validators.Int(not_empty=True),
        "baz": validators.Int(not_empty=True)},
            failsafe_schema=FailsafeSchema.defaults)(failsafedefaults)
