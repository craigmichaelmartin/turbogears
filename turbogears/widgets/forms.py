...
###############################################################################
# Base class for a widget that can generate input for the app.
###############################################################################
...
class CompoundInputWidget(CompoundWidget, InputWidget):
    ...
    def value_for(self, item, value):
        ...
        ``item`` is the child widget instance or it's name, ``value`` is a
    ...
    def params_for(self, item, **params):
        ...
        ``item`` is the child widget instance or it's name, ``params`` is a
    ...
    def error_for(self, item, suppress_errors=False):
        ...
        child widget instance or it's name.
...
class RepeatingInputWidget(CompoundInputWidget):
    ...
    def value_for(self, item, value):
        ...
        ``item`` is the child widget instance or it's name, ``value`` is a dict
